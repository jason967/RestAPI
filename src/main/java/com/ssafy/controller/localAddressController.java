...
public class localAddressController {
	...
	@GetMapping("/aptdeal/{aptname}/{dongcode}")
	public ResponseEntity<List<HouseDeal>> getAptDeal(@PathVariable("aptname") String aptname,
			@PathVariable("dongcode") String dongcode) throws Exception {


		return  new ResponseEntity<List<HouseDeal>>(houseMapService.getAptDetail(aptname, dongcode), HttpStatus.OK);
